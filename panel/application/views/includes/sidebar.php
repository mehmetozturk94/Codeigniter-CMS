            ...
            <div class="media-left">
                <div class="avatar avatar-md avatar-circle">
                    <a href="javascript:void(0)"><img class="img-responsive"
                            src="<?php echo base_url("assets"); ?>/assets/images/221.jpg" alt="avatar" /></a>
                </div><!-- .avatar -->
            </div>
            <div class="media-body">
                <div class="foldable">
                    <h5><a href="javascript:void(0)" class="username">Mehmet Öztürk</a></h5>
                    <ul>
                        <li class="dropdown">
        ...
        <div class="menubar-scroll-inner">
            <ul class="app-menu">
                ...
                <li class="has-submenu">
                    ...
                    <ul class="submenu">
                        <li><a href="<?php echo base_url("assets"); ?>/default/index.html"><span
                                    class="menu-text">Default</span></a></li>
                        <li><a href="<?php echo base_url("assets"); ?>/topbar/index.html"><span
