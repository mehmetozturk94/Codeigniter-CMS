...
var LIBS = {
  ...
  summernote: [
    "../panel/assetsssss/libs/bower/summernote/dist/summernote.css",
    "../panel/assetsssss/libs/bower/summernote/dist/summernote.min.js",
  ],
  DataTable: [
...
+(function (a, b, c) {
  ...
  +(function (a, b) {
    "use strict";
    var c = { name: "Infinity", version: "2.0.0" };
    (c.defaults = {
      menubar: { folded: !1, theme: "light", themes: ["light", "dark"] },
      navbar: {
        theme: "primary",
        themes: [
          "primary",
      ...
      (c.init = function () {
        ...
        b.done(function () {
          a("[data-switchery]").each(function () {
            ...
            new Switchery(this, { color: c, size: e, jackColor: d });
          });
        });
      }),
      (b.app = c);
      ...
      h = {
        ...
        toggleTopbarSubmneuOnHover: function (c) {
          var d = a(this),
            ...
            f = a(b).width();
          f - e < 220
            ? d.find("> .submenu").css({ left: "auto", right: "100%" })
            : f - e >= 220 &&
              !d.is(".app-menu > li") &&
              d.find("> .submenu").css({ left: "100%", right: "auto" }),
